...
export const BoardSettings = () => {
  ...
  // Define the teachers relevant to your assistant
  const teachers = ["Nanami", "Naoki"]; // Keeping the teachers in the context
        ...
        {teachers.map((teacherName, idx) => (
          ...
          >
            <div onClick={() => setTeacher(teacherName)}>
              <img
                src={`/images/${teacherName}.jpg`} // Ensure you have images for these teachers
                alt={teacherName}
                className="object-cover w-40 h-40"
              />
            </div>
